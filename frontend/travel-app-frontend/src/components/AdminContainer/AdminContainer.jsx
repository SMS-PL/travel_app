    ...
    return (
        <div className=" w-full flex flex-col justify-start items-center">
            ...
            <div className="flex flex-row w-full">
                <nav className="fixed h-screen z-[49] left-0 flex flex-col items-center gap-4 px-2 py-4 w-14 border-r bg-background">
                ...
                <div className="w-full flex flex-col justify-start items-center ml-14 md:px-8 box-border">
